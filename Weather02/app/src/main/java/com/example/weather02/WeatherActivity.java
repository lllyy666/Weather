...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        windPowerText = findViewById(R.id.windPower_text);
        windDirectionText = findViewById(R.id.windDirection_text);
    ...
    public void requestWeather(final String adCode) {
        String weatherUrl = "https://restapi.amap.com/v3/weather/weatherInfo?city=" + adCode + "&key=1c330ffb3b0e1314857e112c06dabb72";
   ...
   private void loadBingPic() {
     ...
     private void showWeatherInfo(Weather weather) {
        ...
        String wind_Power = weather.windPower;
        String wind_Direction = weather.windDirection;
        ...
        windDirectionText.setText(wind_Direction);
        windPowerText.setText(wind_Power);
